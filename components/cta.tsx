...
export default function Cta() {
  ...
  return (
    <section className="flex flex-col items-center justify-center pt-8 md:pt-12 pb-16 md:pb-28">
      ...
      <div className="w-full max-w-2xl grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10 px-4">
        {/* Address */}
        <div className="w-full bg-white/5 backdrop-blur-md border border-blue-500/20 rounded-2xl shadow-2xl px-4 py-6 flex flex-col items-start">
      ...
      <div className="w-full max-w-2xl px-4">
        <div className="w-full bg-white/10 backdrop-blur-lg border border-blue-500/20 rounded-2xl shadow-2xl px-4 py-6 mx-auto">
          <form className="flex flex-col gap-4">
            <div className="flex flex-col gap-4 sm:gap-6 md:flex-row">
              <input
                ...
                className="flex-1 rounded-xl px-4 py-3 bg-gray-900/80 text-gray-100 border border-blue-400/20 focus:border-blue-400 focus:ring-2 focus:ring-blue-400 outline-none transition placeholder-gray-400 text-sm sm:text-base md:text-lg shadow-sm"
                required
              />
              <input
                type="email"
            ...
            <textarea
              ...
              rows={4}
              className="rounded-xl px-4 py-3 bg-gray-900/80 text-gray-100 border border-blue-400/20 focus:border-blue-400 focus:ring-2 focus:ring-blue-400 outline-none transition placeholder-gray-400 text-sm sm:text-base md:text-lg shadow-sm resize-none"
              required
            />
            <button
              type="submit"
              className="mt-2 py-3 px-6 rounded-xl font-bold text-base sm:text-lg bg-gradient-to-r from-blue-500 to-green-400 text-white shadow-xl hover:brightness-95 hover:scale-95 active:scale-100 transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-blue-400"
            >
              Send
            </button>
          </form>
